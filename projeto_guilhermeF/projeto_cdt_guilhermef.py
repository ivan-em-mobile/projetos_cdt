...
# Cores hexadecimais para o tema
MAPA_CORES = {
    "Azul / Blue": "#1A73E8",
    "Verde / Green": "#2EA44F",
    "Roxo / Purple": "#8A3FFC"
...
class SistemaApp:
    ...
    def t(self, chave):
        """Função auxiliar para tradução rápida de texto"""
    ...
    def montar_config(self):
        # Card para Configurações Visuais Básicas
    ...
    def alterar_idioma(self, novo_idioma):
        ...
        # Recarrega o painel principal para aplicar os textos traduzidos
        self.painel_principal()
        # Força focar de volta na aba de configurações
        self.abas.set(self.t("aba_config"))

    def alterar_cor_tema(self, nova_cor):
        self.cor_atual = nova_cor
        # Recarrega o painel principal para aplicar as novas cores nos botões e abas
        self.painel_principal()
        self.abas.set(self.t("aba_config"))
