...
COR_TURQUESA      = "#00e3e6"  # Botões dos itens do cardápio e ações secundárias
...
class AplicaçãoHamburgueria:
    ...
    # -------------------------------------------------------------------------
    # NOVO PROCESSO DE CHECKOUT COM TELA DE CONFIRMAÇÃO E BARRA DE ROLAGEM
    # -------------------------------------------------------------------------
    ...
    def abrir_janela_confirmacao_endereco(self, cep, dados_cep):
        ...
        janela_end.configure(bg=COR_AZUL_PETROLEO)
        ...
        frame_form = tk.Frame(janela_end, bg=COR_AZUL_PROFUNDO, padx=15, pady=15)
        ...
        frame_texto = tk.Frame(frame_form, bg=COR_AZUL_PROFUNDO)
    ...
    def abrir_janela_historico(self):
        ...
        janela_hist.geometry("680x380")
        janela_hist.configure(bg=COR_AZUL_PETROLEO)
        ...
        tabela.column("itens", width=200)
        tabela.column("total", width=80, anchor="center")
        tabela.column("endereco", width=280)
